...
CREATE TABLE UserAccount (
    ...
    Renter_Status boolean DEFAULT true
);
...
-- Insert sample data
INSERT INTO LibrarianAccount (username, password) VALUES 
('Anthony', '12345'), 
('Joey','12345'),
('Zakariya','12345'),
('Salmaan','12345');
...
INSERT INTO UserAccount (Renter_Username, Renter_FirstName, Renter_LastName, Renter_Address, Renter_Email, Renter_Status) VALUES
('jsmith', 'John', 'Smith', '123 Main St, City, State', 'jsmith@email.com', true),
('mjohnson', 'Mary', 'Johnson', '456 Oak Ave, City, State', 'mjohnson@email.com', true),
('bwilson', 'Bob', 'Wilson', '789 Pine Rd, City, State', 'bwilson@email.com', true),
('lbrown', 'Lisa', 'Brown', '321 Elm St, City, State', 'lbrown@email.com', false),
('tgarcia', 'Tom', 'Garcia', '654 Maple Dr, City, State', 'tgarcia@email.com', true);
